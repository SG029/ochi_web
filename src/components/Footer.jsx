...
function Footer() {
  return (
    <div className='w-full h-screen flex'>
        <div className='w-1/2 h-full font-["Founders_Grotesk"] text-[6vw] p-20 flex flex-col justify-between'>
            <div className='heading'>
                <h1 className='-mb-6 leading-none uppercase tracking-tight font-semibold'>Eye-</h1>
                <h1 className='-mb-6 leading-none uppercase tracking-tight font-semibold'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 h-full font-["Founders_Grotesk"] text-[6vw] py-20'>
            <div className='heading'>
                    <h1 className='-mb-6 leading-none uppercase tracking-tight font-semibold px-10'>Presentations</h1>
                    <div>
                        <h1 className='text-xl ml-10 mt-10'>S:</h1>
                        <div className='font-["Neue_Montreal"] mt-5'>
                            <a className='block text-xl ml-10' href="">Facebook</a>
                            <a className='block text-xl ml-10' href="">LinkedIn</a>
                            <a className='block text-xl ml-10' href="">Instagram</a>
                            <a className='block text-xl ml-10' href="">Behance</a>
                        </div>
                    </div>
